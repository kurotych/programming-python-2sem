...
**Що автогенерація вміє виявляти:**
...
- Зміни типів колонок
- Зміни nullable
- Зміни індексів та унікальних обмежень
- Зміни зовнішніх ключів

**Що автогенерація НЕ вміє виявляти:**

- Перейменування таблиць (сприймає як видалення + створення)
- Перейменування колонок
- Зміни в назвах constraint

**Важливо:** Завжди перевіряйте згенеровану міграцію перед застосуванням!
